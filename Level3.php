...
$words = ["PINEAPPLE","HIBERNATE", "HELICOPTER","SIXTYNINE","HALLOWEEN"];
$clue =["Tropical fruit", "Bears do this in the winter" , "Mode of transportation" , "Naughty Number" , "Holiday of Winter"];
